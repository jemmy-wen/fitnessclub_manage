...
/**
 * 統一的手機模擬外框，供 LIFF 頁面與 Admin 手機預覽共用。
 * LINE 模擬器有自己的完整實作（含 status bar / header），不使用此元件。
 */
export function MobileShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[#1a1d27] flex items-center justify-center py-8 px-4">
      <div
